import { NEON_ASHES_UNIVERSE } from '@/data/narrative/neon-ashes-universe';
...
export { DUST_AND_IRON_UNIVERSE, NEON_ASHES_UNIVERSE, NEURONET_UNIVERSE };

export const UNIVERSES: Universe[] = [
  DUST_AND_IRON_UNIVERSE,
  NEURONET_UNIVERSE,
  NEON_ASHES_UNIVERSE,
];
